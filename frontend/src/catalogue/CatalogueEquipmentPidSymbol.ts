import { PhaseThreeEquipmentModel } from './CatalogueEquipmentTypes';

export interface EquipmentPidSymbol {
  id: string;
...
const bodyForCategory = (model: PhaseThreeEquipmentModel): string => {
...
export const createCatalogueEquipmentPidSymbol = (model: PhaseThreeEquipmentModel): EquipmentPidSymbol => {
